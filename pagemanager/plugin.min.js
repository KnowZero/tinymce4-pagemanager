...
var search = $(editor.getBody()).find( "p, td, div" ).each( function (i)
{
...
if(0 < telem.scrollTop) telem.scrollTop += -50;
...
var mynode = sidelist[$(this).data('list-id')];
$(mynode).get(0).scrollIntoView();
var telem=$(mynode).closest('body').get(0);
if(0 < telem.scrollTop) telem.scrollTop += 0;
